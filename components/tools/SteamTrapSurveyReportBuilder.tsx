  ...
  return (
    <div className="space-y-8">
      ...
      <div className="print:hidden">
        <h2 className="text-lg font-semibold text-foreground mb-3">Survey Information</h2>
      ...
      <div>
        <div className="flex flex-wrap items-center justify-between gap-3 mb-3 print:hidden">
          <h2 className="text-lg font-semibold text-foreground">Steam Trap Entries</h2>
          <button
        ...
        {traps.length === 0 ? (
          <p className="text-sm text-muted text-center border border-dashed border-border rounded-lg py-8">
            No steam traps added yet.<br />Add a steam trap manually or try the example survey.
          </p>
        ) : (
      ...
      {traps.length > 0 && (
        <div ref={summaryRef} className="space-y-6">
          <div className="rounded-lg border border-l-[3px] border-l-primary border-border bg-accent-bg/30 p-6">
            <h2 className="text-sm font-semibold text-foreground mb-2">Estimated Annual Steam Loss Cost</h2>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-lg border border-border bg-surface p-4">
              <div className="text-xs text-muted mb-1">Total Estimated Steam Loss</div>
              <div className="text-lg font-semibold text-foreground">{formatNumber(summary.totalSteamLossLbHr)} lb/hr</div>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <div className="text-xs text-muted mb-1">Annual Steam Loss</div>
              <div className="text-lg font-semibold text-foreground">{formatNumber(summary.totalAnnualSteamLossLb, 0)} lb/year</div>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
          ...
          <div>
            <div className="mb-4">
              ...
              <p className="text-sm text-muted mt-1">Order: HIGH → MEDIUM → LOW → Unrated → Inspection Required; within the same level, highest annual savings first.</p>
            </div>
